"""ManiSkill 3.0.1 reference source program for T06_LIFT_PEG_UPRIGHT."""
...
from source_programs.vendor.mani_skill_motionplanning.base_motionplanner.utils import compute_grasp_info_by_obb, get_actor_obb
...
def run(env: LiftPegUprightEnv, seed=None, debug=False, vis=False):
    env.reset(seed=seed)

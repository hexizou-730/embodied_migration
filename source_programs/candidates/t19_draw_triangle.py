"""ManiSkill 3.0.1 reference source program for T19_DRAW_TRIANGLE."""
...
from source_programs.vendor.mani_skill_motionplanning.panda.motionplanner_stick import \
    PandaStickMotionPlanningSolver


def run(env: DrawTriangleEnv, seed=None, debug=False, vis=False):
    env.reset(seed=seed)

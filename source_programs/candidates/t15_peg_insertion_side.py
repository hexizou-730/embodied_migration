"""ManiSkill 3.0.1 reference source program for T15_PEG_INSERTION_SIDE."""
...
from source_programs.vendor.mani_skill_motionplanning.base_motionplanner.utils import (
...
def run(env: PegInsertionSideEnv, seed=None, debug=False, vis=False):
    env.reset(seed=seed)
